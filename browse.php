    ...
    <body>
        	...
        	<div id="mainsite">
            	...
            	<div id="boxes">                        
                 <div class="boxMain">
                         <div class="article">
                            <form id="seltyp" method="post" action="php/brred.php" style="display: inline">
                                 <br> <br> <br> <br> Επιλέξετε σε τι θέλετε να περιηγηθείτε: <br>
                                 <select name="type" form="seltyp" class="brtxt">
                                    		<option value="simeiodianomis">Σημείο Διανομής</option>
                                            <option value="ekdotis">Εκδότης</option>
                                            <option value="books">Συγγράμματα</option>
                                </select> 
                                <button id="logbut2" class="logbutc" style="border-top-left-radius: 5px 5px; border-bottom-left-radius: 5px 5px; margin-top: 20px;">Επόμενο</button>
                                <br><br><br><br>
                            </form>                         
                        </div><!--article-->
                    </div><!--Box-->
