    ...
    <body>
        	...
        	<div id="mainsite">
            	...
            	<div id="boxes">                        
                 <div class="boxMain">
                         <div class="article">
                            <form id="seltyp" method="post" action="brbpr.php" style="display: inline">
                                 <br> <br> <br> <br> Επιλέξετε ποιας σχολής τα συγγράμματα θέλετε να προβάλετε: <br>
                                 <select name="sxoli" form="seltyp" class="brtxt">
