            	...
            	<div id="boxes">                        
                 <div class="boxMain">
                         <div class="article">
							...
							?>
                            <br><br><br>Δεν έχετε δηλώσει κανένα βιβλίο ακόμα!<br><br><br>
                            <?php
								}
								else {
									list($id, $namel, $ekdotisl, $isbnl, $writerl, $langl, $sxolil, $imagel) = $stb->getCurrentValues();
									if ($std->next()) {
										list($curbid) = $std->getCurrentValues();
										$stb = $dbb->executeQuery("SELECT * FROM books WHERE id = '".$curbid."';");;								
									}
							?>
                            	<br><br>Τα βιβλία που έχετε δηλώσει μέχρι στιγμής είναι: <br><br>
								<div class="bookbox">
                                	<div class="bookimage">
